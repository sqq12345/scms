...
class WxPayApi
{
	...
	{		
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT, "/www/wwwroot/www.shichamaishou.com/trunk/application/libraries/wxpay/cert/apiclient_cert.pem");
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, "/www/wwwroot/www.shichamaishou.com/trunk/application/libraries/wxpay/cert/apiclient_key.pem");
		}
		//post提交方式
     ...
     * @return 成功时返回，其他抛异常
     */
    public static function unifiedOrderXcx($inputObj, $timeOut = 10)
    {
        $url = "https://api.mch.weixin.qq.com/pay/unifiedorder";
        //检测必填参数
        if(!$inputObj->IsOut_trade_noSet()) {
        ...
        $inputObj->SetAppid(WxPayConfig::XCX_APPID);//小程序APPID
        $inputObj->SetMch_id(WxPayConfig::MCHID);//商户号
        $inputObj->SetSpbill_create_ip($_SERVER['REMOTE_ADDR']);//终端ip
        //$inputObj->SetSpbill_create_ip("1.1.1.1");
        $inputObj->SetNonce_str(self::getNonceStr());//随机字符串
